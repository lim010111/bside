...
> **2026-09-19 제품 방향 전환:** 이 문서의 Q1~Q20 및 기존 개발 인계는 이전 행사 MVP의 결정 이력입니다. 후속 AI 결정은 보존합니다. 새 방향과 충돌하는 행사 한정·방 전체 추천·BLE 제외 정책을 새 요구사항으로 적용하지 않습니다. 현재 결정과 문서 전환 상태는 [BLE 근접 교류 전환](../../../product-direction.md)을 먼저 확인합니다.
